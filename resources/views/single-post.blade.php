<x-layout>
    ...
    <div class="container py-md-3 topmar">
        <div class="d-flex justify-content-between">
            ...
            @can('update', $post)
                <span class="pt-2">
                    <a href="/post/{{ $post->id }}/edit" class="me-2" data-toggle="tooltip" data-placement="top"
                        title="Edit"><i class="far fa-edit"></i></a>
                    <form class="delete-post-form d-inline" action="/post/{{ $post->id }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button class="delete-post-button" data-toggle="tooltip" data-placement="top" title="Delete"><i
