          ...
          <div class="d-flex align-items-center">        
            ...
            @auth
              <div class="d-flex align-items-center">
                ...
                <a class="btn btn-outline-dark-50 me-2" href="/create-post">Post</a>
                  <form action="/logout" method="POST" class="d-inline">
                  @csrf
                    <button class="btn btn-outline-dark-50 me-5">Sign Out</button>
                  </form>
            ...
            @else 
              ...
              @csrf
                <div class="row align-items-center">
                  ...
                  <div class="col-md-auto">
                    <button class="btn btn-outline-dark-50 me-2">Sign In</button>
                  </div>
                </div>
              </form>
              ...
              <div class="col-md-auto me-4">
                <a href="/register">  
                  <button type="submit" class="btn btn-outline-dark-50 me-4">Register</button>
                </a>
              </div>
            @endauth
          </div>
